...
const char* pix_fmt_str[SKRY_NUM_PIX_FORMATS] =
{
    ...
    [SKRY_PIX_CFA_RGGB8] = "PIX_CFA_RGGB8",
    [SKRY_PIX_CFA_GRBG8] = "PIX_CFA_GRBG8",
    [SKRY_PIX_CFA_GBRG8] = "PIX_CFA_GBRG8",
    [SKRY_PIX_CFA_BGGR8] = "PIX_CFA_BGGR8",

    [SKRY_PIX_CFA_RGGB16] = "PIX_CFA_RGGB16",
    [SKRY_PIX_CFA_GRBG16] = "PIX_CFA_GRBG16",
    [SKRY_PIX_CFA_GBRG16] = "PIX_CFA_GBRG16",
    [SKRY_PIX_CFA_BGGR16] = "PIX_CFA_BGGR16",

...
struct list_node *connect_img_sequence(SKRY_ImagePool *img_pool, const SKRY_ImgSequence *img_seq);

void disconnect_img_sequence(SKRY_ImagePool *img_pool, struct list_node *img_seq_node);
...
SKRY_Image *get_image_from_pool(SKRY_ImagePool *img_pool, struct list_node *img_seq_node, size_t img_idx);
